...
The VolumeMute long-press functio is on by default (the navigation labels are V1->V2->V3->V4). To switch it to the
...
Pad[k], then press [*Cm] until *cx* shows then press [NXT]2x[CRF][ADD]EXE].   
